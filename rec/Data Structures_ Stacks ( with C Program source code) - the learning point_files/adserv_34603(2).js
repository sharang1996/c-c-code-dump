...
function TMX_Default(platform) { 
  ...
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=4027264659358268&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=4027264659358268&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function TMX_OpenX(auid) {
  ...
  document.write("               document.write('<scr' + 'ipt src=\"\/\/uat-net.technoratimedia.com\/pixel?rid=4027264659358268&id=2&rev=3&typ=apndef&bid=OPX&sid=34603&cp=' + a.getProperties().pub_rev + '\"> <\/scr' + 'ipt>');");
  document.writeln("	}");
  document.writeln("});");
...
function TMX_DefaultOrPSA(platform) { 
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264659358268&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    document.write('<scr' + 'ipt type="text/javascript" src="' + (tmIsSecure ? 'https://uat-net' : 'http://ad-cdn') + '.technoratimedia.com/psa/psa.js' +'"></scr' + 'ipt>');
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264659358268&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function displayAds() {
	TMX_Default();
...
function TMX_Return() {
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264659358268&id=7"></scr' + 'ipt>');
	varTmxOpx=0;
	TMX_APN('1');
}
...
(typeof window.varTagId !== 'undefined')
	...
	console.log(e);
}var varPixel101=1;}if(window.varPixel103==undefined){try {
    var _mag = _mag || {};
...
}var varPixel73=1;}if(window.varPixel99==undefined){(function(){
		var s = document.createElement("script");
		s.type = "text/javascript";
...
var varPixel99=1;}if(window.varPixel69==undefined){    var __cho__ = {"pid":2578};
    (function() {
