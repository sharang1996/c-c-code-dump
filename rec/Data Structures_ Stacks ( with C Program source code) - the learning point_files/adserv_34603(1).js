...
var vartmsf =  parseFloat('0.19').toFixed(2);
...
function TMX_Default(platform) { 
  ...
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=4027264394725989&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=4027264394725989&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function TMX_OpenX(auid) {
  ...
  document.write("               document.write('<scr' + 'ipt src=\"\/\/uat-net.technoratimedia.com\/pixel?rid=4027264394725989&id=2&rev=3&typ=apndef&bid=OPX&sid=34603&cp=' + a.getProperties().pub_rev + '\"> <\/scr' + 'ipt>');");
  document.writeln("	}");
  document.writeln("});");
...
function TMX_DefaultOrPSA(platform) { 
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264394725989&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    document.write('<scr' + 'ipt type="text/javascript" src="' + (tmIsSecure ? 'https://uat-net' : 'http://ad-cdn') + '.technoratimedia.com/psa/psa.js' +'"></scr' + 'ipt>');
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264394725989&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function displayAds() {
	TMX_Default();
...
function TMX_Return() {
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264394725989&id=7"></scr' + 'ipt>');
	varTmxOpx=0;
	TMX_APN('1');
}
...
if(window.varPixel103==undefined){try {
    var _mag = _mag || {};
...
var varPixel79=1;}if(window.varPixel69==undefined){    var __cho__ = {"pid":2578};
    (function() {
...
var varPixel99=1;}if(window.varPixel101==undefined){try {
...
(typeof window.varTagId !== 'undefined')
	...
	console.log(e);
}var varPixel101=1;}if(window.varPixel73==undefined){if (document.body && document.location.protocol == 'http:') {
var varChannelIDs='4,18,29';
var sectionTargeting='&prm=0&nwk=0&efo=0&dir=0&rem=1&pas=0';
