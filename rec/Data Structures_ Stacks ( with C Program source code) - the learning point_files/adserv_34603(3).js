...
function TMX_Default(platform) { 
  ...
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=4027264878445767&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=4027264878445767&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function TMX_OpenX(auid) {
  ...
  document.write("               document.write('<scr' + 'ipt src=\"\/\/uat-net.technoratimedia.com\/pixel?rid=4027264878445767&id=2&rev=3&typ=apndef&bid=OPX&sid=34603&cp=' + a.getProperties().pub_rev + '\"> <\/scr' + 'ipt>');");
  document.writeln("	}");
  document.writeln("});");
...
function TMX_DefaultOrPSA(platform) { 
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264878445767&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    document.write('<scr' + 'ipt type="text/javascript" src="' + (tmIsSecure ? 'https://uat-net' : 'http://ad-cdn') + '.technoratimedia.com/psa/psa.js' +'"></scr' + 'ipt>');
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264878445767&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function displayAds() {
	TMX_Default();
...
function TMX_Return() {
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027264878445767&id=7"></scr' + 'ipt>');
	varTmxOpx=0;
	TMX_APN('1');
}
