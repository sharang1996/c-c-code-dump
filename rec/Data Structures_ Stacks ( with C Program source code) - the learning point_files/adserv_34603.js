...
var varPublisherId = '15001';
var varTagId='34603';
var varSectionIDAPN='2122359';
var varChannels='tedu,ttch,titn';
var varChannelIDs='4,18,29';
var comscorePlacementId='34603';
var comscoreCategoryId='12400';
var varSiteName='TheLearningPoint';
var varSectionName='TheLearningPoint';
var varAggPubId='15001_34603';
var sectionTargeting='&prm=0&nwk=0&efo=0&dir=0&rem=1&pas=0';
var varPageUrl='http://www.thelearningpoint.net/computer-science/data-structures-stacks--with-c-program-source-code';
var callForPixel = 1;
var varTmxOpx = 0;
var varSectionIDOPX='/*!SECTION_EXCHANGE_ID_OPX*/';
var varauid='/*!auid*/';
var varSectionIDPM='/*!SECTION_EXCHANGE_ID_PM*/';
var varTmxCountry='IN';

var vartmsf =  parseFloat('0.193').toFixed(2);
...
function TMX_Default(platform) { 
  ...
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=4027263247321239&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    ...
    document.write('<script type="text/javascript" src="//uat-net.technoratimedia.com/pixel?rid=4027263247321239&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function TMX_OpenX(auid) {
  ...
  document.write("               document.write('<scr' + 'ipt src=\"\/\/uat-net.technoratimedia.com\/pixel?rid=4027263247321239&id=2&rev=3&typ=apndef&bid=OPX&sid=34603&cp=' + a.getProperties().pub_rev + '\"> <\/scr' + 'ipt>');");
  document.writeln("	}");
  document.writeln("});");
...
function TMX_DefaultOrPSA(platform) { 
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027263247321239&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    document.write('<scr' + 'ipt type="text/javascript" src="' + (tmIsSecure ? 'https://uat-net' : 'http://ad-cdn') + '.technoratimedia.com/psa/psa.js' +'"></scr' + 'ipt>');
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027263247321239&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function displayAds() {
	TMX_Default();
...
function TMX_Return() {
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=4027263247321239&id=7"></scr' + 'ipt>');
	varTmxOpx=0;
	TMX_APN('1');
}
...
if(window.varPixel101==undefined){try {
	if (typeof oldTN8 !== 'undefined') {

	window.tmzEZK=0;
            oldTN8.broadcastMessage({pixel:"tmzEZK", msg:"Pixel Check from " + oldTN8.myId}, {
                merge: function (data) {
                    if (window.tmzEZK ==0) {
                        if (oldTN8.is_defined(data.value)) {
                            if ((data.value == 0) && (data.from < oldTN8.myId)) {
                                window.tmzEZK = -1;
                ...
                run: function () {
                    if (window.tmzEZK === 0) {
                        window.tmzEZK = 1;
if (
(typeof window.varDomainName !== 'undefined') && 
(typeof window.varTagId !== 'undefined')
) {
	window.ezMarkerType = 'technorati';
	window.ezC = ["g:ez101","flt:1","d:" + window.varDomainName + window.varTagId ];
	(function(){
		var s = document.createElement("script");
		s.type = "text/javascript";
		s.src = document.location.protocol + "//technorati.ezakus.net/marker/?group=ez101&tjs="+new Date().getTime();
		s.async = true;
	...
	console.log(e);
}var varPixel101=1;}if(window.varPixel69==undefined){    var __cho__ = {"pid":2578};
    (function() {
...
var varPixel69=1;}if(window.varPixel99==undefined){(function(){
		var s = document.createElement("script");
		s.type = "text/javascript";
...
var varPixel99=1;}if(window.varPixel79==undefined){document.write('<iframe style="visibility:hidden; display:none" src="' + (document.location.protocol == 'https:' ? 'https://ssum-sec.' : 'http://ssum.') + 'casalemedia.com/usermatch?s=180187&r='+Math.floor(Math.random()*11000)+'&cb=' + (document.location.protocol == 'https:' ? 'https' : 'http') + '%3A%2F%2Fuat-net.technoratimedia.com%2Fservices%3Fsrv%3Dcs%26pid%3D1%26uid%3D"></iframe>');
var varPixel79=1;}if(window.varPixel73==undefined){if (document.body && document.location.protocol == 'http:') {
var varChannelIDs='4,18,29';
var sectionTargeting='&prm=0&nwk=0&efo=0&dir=0&rem=1&pas=0';
...
}var varPixel73=1;}if(window.varPixel103==undefined){try {
    var _mag = _mag || {};
